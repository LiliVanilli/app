...
class _HrHrvChartState extends State<HrHrvChart> with SingleTickerProviderStateMixin {
  ...
  /// Combined chart showing both HR and HRV on same timeline with dual Y-axes
          ...
          children: [
            ...
            Row(
              children: [
                ...
                const Text('HR (BPM)', style: TextStyle(fontSize: 12)),
                ...
                const SizedBox(width: 4),
                const Text('HRV (ms)', style: TextStyle(fontSize: 12)),
              ],
            ),
            const SizedBox(height: 16),
            SizedBox(
              height: 250,
              child: (_hrHistory.isEmpty && _hrvRmssdHistory.isEmpty)
                  ? Center(
                      child: Text(
                        'Collecting data...',
                        style: TextStyle(color: Colors.grey[600]),
                  ...
                  : CustomPaint(
                      painter: DualAxisChartPainter(
                        hrData: _hrHistory,
                        hrvData: _hrvRmssdHistory,
                        hrColor: Colors.red,
                        hrvColor: const Color(0xFF4ECDC4),
                      ),
                      size: Size.infinite,
                    ),
            ),
            ...
            Text(
              'Tap on chart to see values at specific time',
